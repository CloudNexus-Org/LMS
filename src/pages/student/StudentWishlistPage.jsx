    ...
    <div className="space-y-8 animate-in fade-in slide-in-from-bottom-4 duration-500 max-w-7xl mx-auto">
      ...
      {isLoading ? (
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
          {wishlist.map((course) => (
            <div key={course.id} className="group flex flex-col rounded-2xl border border-border bg-surface overflow-hidden hover:shadow-card hover:border-border-strong transition-all cursor-pointer">
              ...
              <div className="p-6 flex flex-col flex-1">
                ...
                <div className="mt-auto flex items-center justify-between border-t border-border pt-4">
                  ...
                  <button className="flex items-center gap-2 bg-primary text-white px-5 py-2.5 rounded-lg text-[13px] font-bold hover:bg-primary-hover shadow-sm transition-colors">
