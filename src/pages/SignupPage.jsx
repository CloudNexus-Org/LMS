...
export default function SignupPage() {
  ...
  const handleSubmit = async (e) => {
    ...
    setTimeout(() => {
      setIsLoading(false);
      login({ username: formData.username, fullName: formData.fullName, role: 'student' }, 'mock-jwt-token');
      navigate('/student/dashboard'); // Proceed to dashboard after "signup"
    }, 1500);
  };
...
>
            ...
            <form onSubmit={handleSubmit} className="mt-4 space-y-3.5">
              ...
              {/* FULL NAME */}
              <div>
                <label htmlFor="fullName" className="mb-1.5 block text-[10px] font-semibold uppercase tracking-[0.15em] text-subtle">
                  Full Name
                </label>
                <div
                  className={`
                    ...
                    bg-bg px-4
                    transition
                    focus-within:${errors.fullName ? 'border-danger ring-danger/20' : 'border-primary ring-primary/20'}
                    focus-within:ring-2
                  `}
                >
                  <input
              ...
              {/* USERNAME */}
              <div>
                <label htmlFor="username" className="mb-1.5 block text-[10px] font-semibold uppercase tracking-[0.15em] text-subtle">
                  Username
                </label>
                <div
                  className={`
              ...
              {/* EMAIL */}
              <div>
                <label htmlFor="email" className="mb-1.5 block text-[10px] font-semibold uppercase tracking-[0.15em] text-subtle">
                  Email Address
                </label>
                <div
                  className={`
                    ...
                    bg-bg px-4
                    transition
                    focus-within:${errors.email ? 'border-danger ring-danger/20' : 'border-primary ring-primary/20'}
                    focus-within:ring-2
                  `}
                >
                  <input
              ...
              {/* PASSWORD */}
              <div>
                <label htmlFor="password" className="mb-1.5 block text-[10px] font-semibold uppercase tracking-[0.15em] text-subtle">
                  Password
                </label>
                <div
                  className={`
