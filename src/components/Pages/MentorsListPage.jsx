    ...
    >
      ...
      >
        ...
        <div className="flex items-center justify-between">
          <span
            className={`inline-flex items-center gap-1.5 rounded-full border px-2 py-0.5 text-[10.5px] font-semibold uppercase tracking-[0.14em] ${
              mentor.available
          ...
          >
            <span
              ...
              className={`h-1.5 w-1.5 rounded-full ${
                mentor.available ? "bg-success animate-pulse" : "bg-warning"
              }`}
            />
        ...
        <div className="mt-auto flex items-center justify-between border-t border-border pt-4 text-[12px] text-muted">
          ...
          <span className="text-[12px] font-semibold text-muted transition-colors duration-200 group-hover/mentor:text-primary">
            View →
          </span>
        </div>
      </Link>
            ...
            <div className="grid items-end gap-6 md:grid-cols-[1fr_auto]">
              <div>
                ...
                <p className="mt-4 max-w-[640px] text-[15px] leading-7 text-muted md:text-[16.5px]">
                  Browse {mentors.length} ex-FAANG and senior practitioners.
                  Filter by track, search by specialty, book a 1:1 session in
                  minutes.
                </p>
              </div>
