      ...
      <Container>
        <div className="grid items-center gap-12 lg:grid-cols-[1fr_1.1fr]">
          ...
          <div className="relative mx-auto w-full max-w-[560px]">
            <div
              aria-hidden="true"
              className="pointer-events-none absolute -inset-6 -z-10 rounded-lg bg-gradient-to-br from-primary/10 via-transparent to-accent/[0.06] blur-2xl"
            />
            <div
              aria-hidden="true"
              className="pointer-events-none absolute -inset-1 -z-10 rounded-lg bg-gradient-to-br from-primary/10 via-transparent to-accent/10 opacity-25 blur-lg"
            />
            ...
            <motion.figure
              ...
              className="certificate-paper group relative isolate aspect-[5/4] max-sm:min-h-[350px] max-sm:max-w-[350px] max-sm:mx-auto overflow-hidden rounded-lg border border-border bg-elevated p-6 text-text shadow-[var(--shadow-elevated)] sm:p-8"
            >
              <div
                aria-hidden="true"
                className="pointer-events-none absolute inset-3 rounded-lg border border-primary/25"
              />
              <div
                aria-hidden="true"
                className="pointer-events-none absolute inset-[14px] rounded-lg border border-primary/10"
              />
              ...
              <motion.div
                ...
                className="absolute -top-3 right-6 z-30 inline-flex items-center gap-1.5 rounded-lg border border-success/30 bg-elevated px-3 py-1 shadow-[var(--shadow-card)]"
              >
              ...
              <div className="relative z-10 flex h-full flex-col items-center text-center">
                ...
                <div className="mt-auto grid w-full grid-cols-[auto_1fr_auto] items-end gap-3 pt-3 sm:gap-4 sm:pt-4">
                  ...
                  <motion.div
                    ...
                    className="flex h-16 w-16 shrink-0 flex-col items-center justify-center gap-0.5 rounded-lg border border-border bg-surface p-1.5 shadow-[var(--shadow-card)] sm:h-[72px] sm:w-[72px]"
                  >
